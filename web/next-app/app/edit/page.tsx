...
export default function EditPage() {
  ...
  const handleApply = async () => {
    ...
    try {
      const res = await fetch('/api/llm', {
        ...
        body: JSON.stringify({ instruction, html: preview }),
      });
  ...
  return (
    <main className="max-w-3xl mx-auto p-8">
      <h1 className="text-2xl font-bold mb-4">Word編集ページ</h1>
      ...
      <div className="flex gap-2 mb-4">
        <button className="btn" onClick={handleApply} disabled={loading}>Apply</button>
